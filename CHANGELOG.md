...
- Dividers: `divider <a> <b>` draws the suppressed boundary between two
  members of a block as a thin dashed level-change line (the edge of a
  dais or a raised half), cut wherever a stair entrance carries a flight
  through it (see `docs/divider.md`).
